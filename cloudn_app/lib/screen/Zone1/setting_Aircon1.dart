...
class SettingAircon1 extends StatefulWidget {
  @override
  _SettingAircon1State createState() => _SettingAircon1State();
}

class _SettingAircon1State extends State<SettingAircon1> {
        ...
        body: ListView(children: <Widget>[
          ...
          Container(
            ...
            child: Column(children: <Widget>[
              ...
              SizedBox(height: 30),
              RaisedButton(
                child: Text('저장'), onPressed: () => Navigator.pop(context),),
              SizedBox(
                height: 50,
              ),
            ]),
