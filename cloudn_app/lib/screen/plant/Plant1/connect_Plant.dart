...
import 'find_Plant.dart';

class ConnectPlant extends StatelessWidget {
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Column(
                    children: <Widget>[
                      Text(
                        '1. Plant의 전원을 연결하고 정면 LED가 주황빛으로 깜빡이는 것을 확인하세요.'
                        ...
                        children: <Widget>[
                          ...
                          RaisedButton(
                            ...
                            onPressed: () => Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => FindPlant())),
                          ),
                        ],
                      ),
                      SizedBox(height: 8),
                      Text('※ 하드웨어 전원 연결 시 정면의 LED가 주황빛으로 깜빡이다가, '
                          'Plant 찾기 버튼을 누를때 주황빛이 계속 켜져있어야 합니다.'),
                      Text(
                        '\n\n3. Plant의 정면 LED가 주황빛으로 깜빡이는 것을 멈추고 계속 켜져있다면, '
